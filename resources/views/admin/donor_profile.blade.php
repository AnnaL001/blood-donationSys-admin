...
@section('vertical_navbar')
    ...
    <nav class="navbar bg-light">
        ...
        <ul class="navbar-nav" style="height:490px;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/blood_donation') }}" style="color:black;margin-left:10px;">Donation</a>
            </li>
            <li class="nav-item">
    ...
    <div class="jumbotron" style="height: 300px;">
        <div class ="row">
            ...
            <div class="column middle" style=" width: 70%">
                <div id="content">
                    <h6 style="margin-left:15px;"> First name :  {{  $donors->first_name }}</h6>
                    <h6 style="margin-left: 15px;"> Last name : {{  $donors->last_name }}</h6>
                    <h6 style="margin-left: 15px;"> Surname : {{  $donors->surname }}</h6>
                    <h6 style="margin-left: 15px;"> Email  : {{  $donors->email }}</h6>
                    <h6 style="margin-left: 15px;"> Phone No : {{  $donors->phoneNo }}</h6>
                    <h6 style="margin-left: 15px;"> Gender : {{ $donors->gender }}</h6>
                    <h6 style="margin-left: 15px;"> Blood type : {{ $donors->blood_type  }}</h6>
