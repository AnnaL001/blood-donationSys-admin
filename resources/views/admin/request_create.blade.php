    ...
    <center>
        <div class="container">
            <div class="row justify-content-center">
             ...
             border-style: groove";><i class='fas fa-paper-plane' style='font-size:16px'></i>{{ __('Send Request') }}</div>
                        ...
                        <div class="card-body" style="border-style: groove">
                            ...
                            <form method="POST" action="{{ route('admin.requests.store') }}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="request_text" class="form-control" name="request_text"></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="branch" type="number" class="form-control" name="branch">
                                    </div>
                                </div>
