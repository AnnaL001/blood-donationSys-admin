    ...
    <center>
        <div class="container">
            <div class="row justify-content-center">
             ...
             border-style: groove";><i class='fas fa-hospital' style='font-size:16px'></i>{{ __('Edit Branch') }}</div>
                        ...
                        <div class="card-body" style="border-style: groove">
                            ...
                            <form method="POST" action="{{ route('super_admin.branches.update', $branches -> branch_id) }}" >
                                {{ method_field('PUT') }}
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="branch_name" type="text" class="form-control" name="branch_name" value="{{ $branches -> branch_name  }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="branch_location" type="text" class="form-control" name="branch_location" value="{{ $branches -> branch_location  }}">
